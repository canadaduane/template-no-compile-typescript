...
// that matches the name of the directory.
export as namespace handlers;

// Note that a namespace MUST be used, unless you want to:
//
...
//     `@type {import('./handlers.d.ts').ServerFn}`. In this case, you do not need
